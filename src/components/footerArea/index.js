        ...
        return (
            <Footer className="footer">
                ...
                <Row>
                    ...
                    <Col span={2} >
                        <Button className="footer-left-text" type="text" onClick={this.showModal.bind(this, 0)}>使用协议</Button>
                        <Button className="footer-left-text" type="text" onClick={this.showModal.bind(this, 1)}>隐私政策</Button>
                    </Col>
                    <Col xxl={3}></Col>
                </Row>
